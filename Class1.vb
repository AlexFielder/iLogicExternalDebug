...
#Region "Properties"
        ...
        Sub Update()
            ...
            Select Case iProperties.SetorCreateCustomiProperty(ThisApplication.ActiveDocument, "BasePartNumber")
        ...
        End Sub
        'Key Parameters
        Public NumFiltersWide As Inventor.Parameter = Parameters.GetParameter("NumFiltersWide")
        Public NumFiltersHigh As Inventor.Parameter = Parameters.GetParameter("NumFiltersHigh")
        Public NumFiltrationStages As Inventor.Parameter = Parameters.GetParameter("FilterHouseNumFiltrationStages")
